...
description: Flexible conversation flow with branching capabilities
---

LobeHub offers a sophisticated chat interface that goes beyond linear conversations, enabling you to explore multiple paths and directions in your discussions with AI agents.

## Core Chat Features

The chat interface provides a modern, responsive experience optimized for both desktop and mobile devices:
...
<Tabs>
  ...
  <Tab title="Creative Writing">
    **Iterating on Content**
    ...
    ```
    "Write an opening paragraph for my blog post"
    ├─ Professional tone
  ...
  <Tab title="Learning">
    **Adaptive Learning Paths**
    ...
    ├─ Control flow concepts (continuing)
